...
def document_summary():
     ...
     summary = ollama.chat(model='llama3:latest', messages=[
          {
          'role': 'system',
          'content': 'Your goal is to summarize a text document so that a human can understand what the main components of the document are. Only include information that is part of the document. Focus on providing a summary in an outline form text with a summary of the key points of the document. Do not include your own opinion or analysis.'
          },
     {
          'role': 'user',
...
def document_summary_rest():
     ...
     prompt = """Your goal is to summarize a text document so that a human can understand what the main components of the document are. Only include information that is part of the document. Focus on providing a summary in an outline form text with a summary of the key points of the document. Do not include your own opinion or analysis."""
...
if uploaded_file is not None:
    ...
    st.text_area("Summary", document_summary_rest(), height=300)
